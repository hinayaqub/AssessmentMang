...
namespace CLOApp
{
    public partial class frmAddRubricLevel : Form
    {
        public frmAddRubricLevel()
        {
            InitializeComponent();
        }
...

        {
            ...
            frmRubricLevelDetail s1 = new frmRubricLevelDetail();
            s1.Show();
            this.Hide();
        }
        ...
        {
            frmRubricLevelDetail r1 = new frmRubricLevelDetail();
            r1.Show();
            this.Hide();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("All fields Sholud not empty");
            }
        }

        private void btnDetails_Click(object sender, EventArgs e)
        {
            frmRubricLevelDetail rubriclvl =new frmRubricLevelDetail();
            rubriclvl.Show();
            this.Hide();
       }
    }
